...
const OrdersList = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch("/port/api/v1/user/users-with-orders");
    ...
    const handleStatusUpdate = async (orderId, newStatus) => {
        try {
            const response = await fetch(
                `/port/api/v1/user/orders/${orderId}/status`,
                {
                    method: "PUT",
                                            ...
                                            {order.payment.transactionType === "Online" ? (
                                                <>
                                                    ...
                                                    <p>
                                                        ...
                                                        <img src={order.payment.transactionImage} className="h-40 w-40" alt="" />
