...
const Users = () => {
    ...
    useEffect(() => {
        ...
        const fetchUsers = async () => {
            try {
                const response = await fetch(`/port/api/v1/user/readAllUsers`); // Assuming your API endpoint is at /api/users
                if (!response.ok) {
...
//         const fetchUsers = async () => {
//             try {
//                 const response = await fetch('/port/api/v1/user/readAllUsers');
//                 if (!response.ok) {
//                     throw new Error('Failed to fetch user data');
//                 }
//                 const data = await response.json();
...
//         try {
//             const response = await fetch(`/port/api/v1/user/delete/${userId}`, {
//                 method: 'DELETE',
//             });
//             if (!response.ok) {
