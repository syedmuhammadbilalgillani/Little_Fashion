...
function Banner() {
  ...
  const images = [
  {
    src: Image1,
    h1: "Cool Fashion",
    h5: "Discover trendy outfits and accessories that fit your lifestyle. Designed for comfort, styled for confidence.",
  ...
  },
  {
    src: Image2,
    h1: "New Arrivals",
    h5: "Stay ahead of the trend with our latest collections. Fresh designs, premium quality, and exclusive offers.",
  ...
  },
  {
    src: Image3,
    h1: "Talk to Us",
    h5: "Have questions or need help with your order? Our support team is here 24/7 to assist you anytime.",
