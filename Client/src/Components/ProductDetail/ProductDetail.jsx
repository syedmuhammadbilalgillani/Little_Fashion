            ...
            {!isLoading && product && (
                <div className="grid grid-cols-2 px-[6%] w-full py-[9vw] dark:text-white">
                    ...
                    <div className="col-span-1 md:col-span-2 sm:col-span-2 xs:col-span-2 mx-[2vw] p-[3vw]">
                        ...
                        <h3 className="text-[max(1vw,1rem)] font-extralight font-sans">Original package design from house</h3>
                        <div className="my-[max(2vw,2rem)] space-y-3">
                            <h3 className="text-[max(1vw,1rem)] font-bold font-sans">Description</h3>
                            ...
                            <div className="flex xs:flex-wrap justify-between w-full gap-[1vw] py-[max(3vw,3rem)] ">
                                <div className="w-full border-gray-400 bg-white text-black border text-[max(1vw,1rem)] ">
                                    <select id="numbers" className="bg-white p-[1vw]  outline-none w-full" onChange={handleQuantityChange}>
                                ...
                                <button onClick={handleAddToCart} className="uppercase w-full bg-black hover:bg-[--red] p-3 text-[max(1vw,0.8rem)] text-white">Add to cart</button>
                            </div>
                        </div>
                    </div>
                </div>
