      ...
      {showSearch && (
        <div>
          <input
            ...
            value={searchTerm}
            className={`focus:outline-none border-[1px] border-gray-300 rounded-md p-1.5 ${
              expanded ? "w-72" : "w-16"
...
const ProductItem = ({ product, badges }) => (
  <div
    className="col-span-4 xs:col-span-12 md:col-span-6"
    data-aos="flip-up"
  ...
  >
    <div className="relative ease-linear">
      ...
      <Link
        ...
        className="py-[max(1vw,1rem)] flex justify-between items-center"
      >
        <div>
